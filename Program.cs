...
class Program
{
    ...
    static async Task Main()
    {
        ...
        _botClient = new TelegramBotClient("7230706546:AAGmgVrFE1RF2bwvxnYwetMCuVsnSol2PKc"); // Присваиваем нашей переменной значение, в параметре передаем Token, полученный от BotFather
